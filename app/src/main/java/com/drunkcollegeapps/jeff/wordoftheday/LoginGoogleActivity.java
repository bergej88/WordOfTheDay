...
public class LoginGoogleActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener{
    ...
    private static final int RC_SIGN_IN = 9001; // This was directly from the google tutorial, still have to figure out where/why it's used.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDetailTextView = (TextView) findViewById(R.id.tvDetail);
        ...
        // TODO Translate wtf google is doing below.
        // [START config_signin]
